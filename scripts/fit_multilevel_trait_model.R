...
m2b_samp <- jags.samples(m2b_fit, c("a_species","sd_species", "mu_b_drought", "mu_b_water", "mu_b_grass", "mu_b_grassxdrought", "mu_b_grassxwater", "b_drought", "b_grass", "b_water", "sd_b_drought",  "sd_b_water", "sd_b_grass", "sd_b_grassxdrought", "sd_b_grassxwater"), n.iter=2000)
(m2b_samp)
...
m2b_samp <- jags.samples(m1, c("a_species", "g_drought", "sd_b_drought", "g_water", "sd_b_water",  "g_grass", "sd_b_grass"), n.iter=2000)
(m1_samp)
